...
当前阶段：**P5 玄天界养成与冒险切片开发**。仓库已具备可运行的多适配器基础框架、凡人引导、首次入道、
感气成长、基础闭关、体质根性、道脉天书、神通参悟、低阶法器祭炼/灵纹重铸、最小居所、生产、探索、悬赏和主线道途前三关；秘境战斗与自动回合 PVE/PvP 仍按文档后置，
...
`docs/reference-sources.md`，适配器设计见 `docs/extension-adapters.md`。
