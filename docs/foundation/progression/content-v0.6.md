...
`quest.dao_union` 要求：完成一条三界主线、贡献一次跨服宗门战或等价个人挑战、交付一种本职业终局作品。领取许可时同事务发放 12 个绑定道果碎片（合道消耗 10 个，合道 L6 前往道源门消耗 2 个）和 1 张绑定天劫凭证。三项道源任务各在当季完成 3/3 时同事务发放 1 张天劫凭证；四张凭证覆盖一次天劫台行程与三次试炼。资格与发奖快照必须保存，以免赛季条件更新后破坏历史记录。
