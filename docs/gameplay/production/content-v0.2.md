...
当前运行时已开放表中五条配方的个人预览、生产和结算；洞天设施槽位、维护费和成品使用效果仍按下阶段合同处理。`formation 3`、`alchemy 3/4`、`artifice 3` 和 `cooking 2` 在订单质量快照中分别冻结为基础熟练度 `4000/4000/5000/4000 bp`，质量仍按 v0.1 公式和服务端随机池计算；金丹配方和云剑使用 6000 成功阈值，云茶使用 4500 成功阈值。
