...
| `demon.abyss_gate` | 筑基、完成 `quest.demon_intro` | 2 分钟 / 10 体力 | 魔界引导、契约风险教学；不开放核心区 | `locked` 到 v0.3 |
...
| `route.cloud_to_abyss_intro` | `demon.abyss_gate` | 筑基、魔界引导任务 | 500 灵石、10 体力 | 5 分钟 | 到达锁定入口，只可接引导 |
