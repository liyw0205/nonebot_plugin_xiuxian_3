...
补齐探索遭遇和多人 PVE，再按独立切片扩展终局战和 PvP。未出现在
...
1. 补齐探索遭遇和多人 PVE；多人会话必须使用队伍快照、锁定资产和唯一奖励结算。
2. 建立终局最终战多人会话（1 名发起者、最多 4 名协助者），再开放飞升/留界真实玩家路径。
3. 完成终局天榜、赛季候选/三榜和展示结算。
4. 最后实现正式 1v1/多方 PvP；金丹至渡劫内容继续按独立境界切片开放。
