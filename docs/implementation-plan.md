...
P4 的最小切片已经落地：感气调息会话、资源锁定/取消、按快照结算、境内/总修为、逐层
晋升、30 分钟资源恢复和资料卡增强。下一步继续补齐感气 L1–L10 的内容解锁与会话恢复，
再开放灵泉谷、正式生产和聚气突破。战斗运行时仍以后置门槛为准，不在本阶段提前实现。
...
或内部稳定键。P4 当前只开放感气调息与资源恢复，聚气以上、正式生产和战斗仍未开放。
