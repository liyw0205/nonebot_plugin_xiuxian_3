...
客房以 20 灵石租住 3 天，供静养闭关使用。天赋、技能、法器和灵兽保持关闭。
随后已接入 `constitution.profile`：六选一主质、资格/道途/境界快照、体质档案查询、重塑令
消耗与 30 天冷却；天赋、技能、法器和灵兽仍保持关闭。
...
当前目标虚拟环境的回归结果为 `80 passed`；系统 Python 为 `79 passed, 1 skipped`（缺少
...
聚气/筑基突破、首版个人生产、四种探索模式和草药/生产悬赏；金丹以上突破、生产委托、
秘境/遗府和战斗仍未开放。
