...
14. **下一步**：补齐其他三界多人副本或阵营战的独立会话与事件贡献投影；继续保持跨服匹配、玩家间资产转移和复杂市场关闭，并先为每个新副本补规则、迁移、QQ/OneBot 契约测试和恢复演练。
...
16. **下一步**：补齐 `event.beast_trade`、`event.boundary_rift` 等公共事件贡献投影和阵营战完整轮次；继续保持跨服匹配、玩家间资产转移和复杂市场关闭，并为公共事件补来源 operation、轮次恢复和双适配器领奖测试。
