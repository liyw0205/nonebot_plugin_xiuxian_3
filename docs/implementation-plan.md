...
下一步进入 P4 的最小切片：感气基础修炼循环、体力/精力恢复和资料卡增强。修炼必须先
落地会话快照、资源锁定、结算幂等和逐层晋升测试，再开放更多地点、生产或突破。战斗
