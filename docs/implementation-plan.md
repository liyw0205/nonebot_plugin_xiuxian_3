...
10. **已完成（v0.2 世界垂直切片）**：云铁矿区悬赏、云舟试炼（含风暴选择、QQ/OneBot 模拟适配器验收）、洞天精英悬赏凭证来源和阵堂迷雾屏障生产（配方注册、材料/精力/灵石扣除、质量快照、失败返还、权限复核、QQ/OneBot 验收）玩家路径已接入。
11. **当前阶段**：继续补齐 v0.2 其它金丹配方、洞天设施槽位/维护和高阶资源链；魔界核心区仍关闭，不得作为 PvP 夹具入口，也不开放跨服匹配或身份合并。
