...
12. **当前阶段（v0.3 魔界单人切片，`partial`）**：魔界堕落遗迹单人探索已接入元婴 L1/每日次数/污染上限/跨界惩罚/魔核或魔界声望掉落/失败神魂疲劳，探索与自动战斗均冻结 `content-0.3` 及对应规则版本，并通过 QQ 官方和 OneBot V11 模拟适配器验收。下一步补齐正式魔界事件与契约线索来源，再进入妖界万兽山与跨界 2–5 人副本；魔界完整核心区、妖界和多人副本仍未开放。
